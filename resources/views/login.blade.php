    ...
    <div class="w-full max-w-5xl mx-auto px-4 py-4 relative z-10">
        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 animate-slide-up max-h-[90vh]">
            <div class="grid md:grid-cols-2 gap-0 min-h-[550px]">
                ...
                <div class="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-8 flex flex-col justify-center relative overflow-hidden">
                    <!-- Simplified decorative elements -->
                    <div class="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full -mr-32 -mt-32 animate-pulse-slow"></div>
                    <div class="absolute bottom-0 left-0 w-48 h-48 bg-white/10 rounded-full -ml-24 -mb-24 animate-pulse-slow animation-delay-2000"></div>
                    
                    <div class="relative z-10 text-center">
                        <!-- Compact Logo & Title -->
                        <div class="mb-6 animate-fade-in">
                            <!-- Logo Container -->
                            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-white/25 to-white/10 backdrop-blur-xl rounded-2xl shadow-xl mb-6 transform hover:scale-110 transition-all duration-500 hover:rotate-3">
                ...
                <div class="p-8 flex flex-col justify-center">
                    <div class="max-w-sm mx-auto w-full">
                        ...
                        <form method="POST" action="/login" class="space-y-4">
                            ...
                            <div class="group">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <a href="#" class="text-xs font-semibold text-blue-600 hover:text-blue-700 hover:underline transition-colors">
                                        Forgot?
                                    </a>
                                </div>
                                <div class="relative">
                        ...
                        <div class="mt-6 text-center">
                            ...
                            <a href="/register" 
                               class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700 font-semibold rounded-xl border-2 border-gray-200 hover:border-blue-300 hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200 group text-sm">
